...
public class Main {
    public static void main(String[] args) {
        ...
        if (startVertex < graph.length) {
            BreadthFirstSearch breadthFirstSearch = new BreadthFirstSearch(graph, startVertex);

            System.out.println("The BFS Tree of the vertex " + vertices[startVertex] + " is:");
            for (Pair<Integer, Integer> edge : breadthFirstSearch._bfsTree) {
